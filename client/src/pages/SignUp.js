			...
			>
				<div className="flex flex-col justify-evenly">
					<div className="py-1 flex flex-col items-start">
						<label className="relative w-full" htmlFor="sign-up-username">
					...
					<div className="py-1 flex flex-col items-start">
						<label className="relative w-full" htmlFor="sign-up-email">
					...
					<div className="py-1 flex flex-col items-start">
						<label className="relative w-full" htmlFor="sign-up-password">
